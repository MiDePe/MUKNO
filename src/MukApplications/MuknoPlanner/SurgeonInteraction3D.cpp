...
namespace muk
{
  /**
  */
  struct SurgeonInteraction3D::Impl
  {
    Impl()
  ...
  vtkStandardNewMacro(SurgeonInteraction3D);

  /**
  */
  SurgeonInteraction3D::SurgeonInteraction3D()
  ...
  /**
  */
  void SurgeonInteraction3D::initialize()
  {
  ...
  /**
  */
  void SurgeonInteraction3D::OnLeftButtonDown()
  {
  ...
  */
  void SurgeonInteraction3D::OnRightButtonDown()
  {
    selectInteraction();
  }
  ...
  /**
  */
  void SurgeonInteraction3D::selectInteraction()
  {
  ...
  ///**
  //*/
  //void SurgeonInteraction3D::moveWaypointImpl()
  //{
  ...
  /**
  */
  void SurgeonInteraction3D::rightClickMenuImpl()
  {
    if (mp->type == EnInteraction::createRightClickMenu && mp->mouseType == EnMouseInteraction::none)
    {
	  ...
	  menu->addHandle("Reset orientation", std::bind(&SurgeonInteraction3D::resetOrientation, this));
     menu->addHandle("Reposition current region", std::bind(&SurgeonInteraction3D::repositionRegion, this));
   /*    menu->addHandle("Create Sphere Region",    [&] () { emit activateInteraction("SphereRegionInteraction"); });
      ...
      menu->addSeparator();
      menu->addHandle("Cut out new Obstacle", std::bind(&SurgeonInteraction3D::cutOutObstacle, this));
      menu->addSeparator();
      menu->addHandle("Create Kappa Sphere", std::bind(&SurgeonInteraction3D::createSphere, this));
      menu->addHandle("Show nearest neighbor", std::bind(&SurgeonInteraction3D::showClosestPoint, this));
      menu->addHandle("Show closest point to path", std::bind(&SurgeonInteraction3D::showClosestPointToPath, this));
      menu->addSeparator();
      menu->addHandle("Set Default Focus", std::bind(&SurgeonInteraction3D::setDefaultFocus, this));
      menu->addSeparator();
      menu->addHandle("Toggle Distance Line", std::bind(&SurgeonInteraction3D::toggleDistanceLine, this));
      menu->addHandle("Toggle Axes", std::bind(&SurgeonInteraction3D::toggleAxes, this)); */
      menu->exec();
    }
  }

  void SurgeonInteraction3D::resetOrientation() 
  {
	  LOG_LINE << "reset orientation (right click menu)";
  }


  /** \brief Activates the popup menu if no moving was performed
  */
  void SurgeonInteraction3D::OnRightButtonUp()
  {
    if (mp->waypointsActive())
    {
  ...
  */
  void SurgeonInteraction3D::OnMouseMove()
  {    
  ...
  */
  void SurgeonInteraction3D::OnMouseWheelForward()
  {
  ...
  */
  void SurgeonInteraction3D::OnMouseWheelBackward()
  {
  ...
  /**
  */
  void SurgeonInteraction3D::repositionRegion()
  {
  ...
  */
  void SurgeonInteraction3D::createSphere()
  {
  ...
  */
  void SurgeonInteraction3D::showClosestPoint()
  {
  ...
  */
  void SurgeonInteraction3D::showClosestPointToPath()
  {
  ...
  /**
  */
  void SurgeonInteraction3D::setDefaultFocus()
  {
    auto p = mp->pCursor->getPosition();
  ...
  */	
  void SurgeonInteraction3D::doDistanceMeasurement(const Vec3d& point)
  {
  ...
  */	
  void SurgeonInteraction3D::drawAxesLines(const Vec3d& point)
  {
    int length = 10;
  ...
  */	
  void SurgeonInteraction3D::drawAxesPlanes(const Vec3d& point)
  {
    int length = 10;
  ...
  */
  void SurgeonInteraction3D::toggleDistanceLine()
  {
  ...
  2: 3d planes 
  */
  void SurgeonInteraction3D::toggleAxes()
  {
  ...
  /**
  */
  void SurgeonInteraction3D::activateInteraction(const std::string& key)
  {
  ...
  /**
  */
  void SurgeonInteraction3D::cutOutObstacle()
  {
